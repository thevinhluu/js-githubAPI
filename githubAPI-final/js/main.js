...
class GITHUB {
	constructor() {
		this.client_id = 'c5b26dcbf94d59dd894e';
		this.client_secret = '8168b7014aa7ced063569e20071529a6a70988b4';
	...
	async ajaxUser(userValue) {
		...
		//repos url
		const reposURL = `${this.base}${userValue}/repos?client_id='${this.client_id}'&client_secret='${this
			.client_secret}'`;
